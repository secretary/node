...
running command...
$ secretary (--version)
@secretary/cli/4.0.6 linux-x64 node-v18.12.1
...
_See code: [dist/commands/inject/index.ts](https://github.com/secretary/node/blob/v4.0.6/dist/commands/inject/index.ts)_
<!-- commandsstop -->
